...
#define log_level_set_error() \
  do { \
    Logger::get_instance().set_level(Logger::Level::ERROR); \
  } while (false)

#define log_level_set_fatal() \
  do { \
    Logger::get_instance().set_level(Logger::Level::FATAL); \
  } while (false)

#define log_get_level() Logger::get_instance().get_level()
...
#define log_debug(...) \
  do { \
    if (log_level_can_print(Logger::Level::DEBUG)) { \
...
#define log_trace(...) \
  do { \
    if (log_level_can_print(Logger::Level::TRACE)) { \
...
#define log_info(...) \
  do { \
    if (log_level_can_print(Logger::Level::INFO)) { \
...
#define log_warn(...) \
  do { \
    if (log_level_can_print(Logger::Level::WARN)) { \
...
#define log_error(...) \
  do { \
    if (log_level_can_print(Logger::Level::ERROR)) { \
...
#define log_fatal(...) \
  do { \
    if (log_level_can_print(Logger::Level::FATAL)) { \
